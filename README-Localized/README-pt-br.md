...
##<a name="device-requirement"></a>Requisito do dispositivo
...
9.    Após adicionar o aplicativo com êxito, você será direcionado para a página **Início Rápido** do aplicativo. Desse local, escolha **Configurar** no menu superior.
10. Na seção Permissões para outros aplicativos, adicione o aplicativo Microsoft Graph.
...
As classes de autenticação são encontradas no módulo [o365-Auth](/o365-auth). Essas classes usam a [Biblioteca do Microsoft Azure Active Directory (ADAL) para Android](https://github.com/AzureAD/azure-activedirectory-library-for-android) para se conectar ao Microsoft Graph. 
